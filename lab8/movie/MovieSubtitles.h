...
namespace moviesubs
{
    ...
    public:
        ...
        SubtitlesException(int num_line, std::string line_text) : std::invalid_argument{"At line " + std::to_string(num_line) + ": " + line_text}{};
    };
    ...
    public:
        ...
        SubtitleEndBeforeStart(int num_line, std::string line_text): SubtitlesException(num_line, line_text){num_val=num_line;};
        int num_val;
